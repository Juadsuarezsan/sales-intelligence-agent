# Architecture — B2B Sales Intelligence Agent

## Summary

Plan-execute-reflect agent over Tavily web search + HackerNews. Produces structured CompanyProfile + personalized OutreachEmail with measurable personalization.
